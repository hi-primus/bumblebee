  ...
  <NuxtLayout>
    <client-only>
      <Tabs
        ...
        :tabs="
          ['Buttons', 'Fields', 'Forms', 'Misc'].map(tab => ({
            label: tab
          }))
        "
      />
      <div class="components-container pb-[500px]">
        <template v-if="selectedTab === TABS.MISC">
            ...
            <PlotBarsBase
              ...
              @hovered="
                hovered = {
                  ...
                  value: notColumnValues[$event]
                }
              "
            />
          </div>
        </template>
        <template v-if="selectedTab === TABS.BUTTONS">
          <div
            class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start min-w-[200px]"
          >
            <AppButton
            ...
            <AppButton
              v-tooltip:bottom.primary.lg="'Same as before but static'"
            >
              Accept
            </AppButton>
          ...
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            ...
            <AppButton loading class="layout-invisible size-smallest"
              >Invisible</AppButton
            >
            <AppButton loading class="layout-text size-smallest"
              >Text</AppButton
            >
          ...
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            ...
            <AppButton class="color-danger layout-invisible">
              Delete
            </AppButton>
          ...
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            ...
            <AppButton class="color-neutral layout-invisible">
              Cancel
            </AppButton>
          ...
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            ...
            <AppButton class="size-small layout-invisible">
              Invisible
            </AppButton>
          ...
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            ...
            <AppButton
              class="size-small color-danger icon-button rounded-button"
            >
              <Icon :path="mdiTrashCan" />
            </AppButton>
          </div>
          <div class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start">
            <AppButton class="size-small color-primary-light"
              >Dismiss</AppButton
            >
        ...
        <template v-if="selectedTab === TABS.FIELDS">
          <div
            class="flex flex-wrap gap-4 px-8 py-2 justify-start items-start min-w-[200px]"
          >
            <AppFile
...
const selectedTab = ref(TABS.BUTTONS);
