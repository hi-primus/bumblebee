    ...
    >
      ...
      >
        <div
          ...
          :style="{
            top: columnHeaderHeight + row.__bumblebee__rowIndex * 24 + 'px'
          }"
          class="h-[24px] absolute bg-white pr-2 z-[-3] text-right w-full op-50 bg-white"
        ></div>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="italic px-3 py-4">[-------------][--]</div>
          </div>
          <div
            class="absolute px-1 border-line-light border w-[calc(100%+1px)] h-[25px] ml-[-1px] mt-[-1px] ellipsis"
            v-for="row in rowsData"
            :style="{
              top: columnHeaderHeight + row.__bumblebee__rowIndex * 24 + 'px'
            }"
      ...
      <div class="sticky h-full left-0 order-[-1]">
        ...
        >
          <div
            ...
            class="h-[24px] absolute w-full pr-[6px] z-[1] bg-white border-line-light border-r"
          >
