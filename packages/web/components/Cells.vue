  ...
  methods: {
    ...
    async compileDataset () {
      try {
        ...
        var response = await this.evalCode(payload, 'requirement')
    ...
    async runCell (cell) {
      try {
        ...
        var response = await this.evalCode(cell, 'requirement');
    ...
    async downloadDatasetRerun () {
      try {
        ...
        var payload = await this.$store.dispatch('finalCommands', { ignoreFrom: -1, include });
        var response = await this.evalCode(payload, 'after_update');
