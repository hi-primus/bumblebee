...
IF %spark% == True (
  ...
  pip install --upgrade git+https://github.com/hi-primus/optimus.git@v23.5.0-beta#egg=pyoptimus[spark]
) ELSE (
  echo Installing optimus
  pip install --upgrade git+https://github.com/hi-primus/optimus.git@v23.5.0-beta
)
