...
if [ "$spark" = true ]; then
  ...
  pip install --upgrade git+https://github.com/hi-primus/optimus.git@develop-21.9#egg=pyoptimus[spark]
else
  echo "Installing optimus"
  pip install --upgrade git+https://github.com/hi-primus/optimus.git@develop-21.9
fi
